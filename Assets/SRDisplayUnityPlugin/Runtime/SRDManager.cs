...
namespace SRD.Core
{
    ...
    public class SRDManager : MonoBehaviour
    {
        ...
        [SerializeField]
        //[RangeLog10Attribute(_minScaleInInspector, _maxScaleInInspector), Tooltip("")]
        ...
        void OnEnable()
        {
            ...
            CreateDisplayEdges();
            _srdCrosstalkCorrection.Init(ref IsCrosstalkCorrectionActive);
        ...
        void Update()
        {
            ...
            UpdateScaleIfNeeded();
            _srdCrosstalkCorrection.HookUnityInspector(ref IsCrosstalkCorrectionActive);
        }
